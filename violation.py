...
critical_violations = {
    ...
    "02C": "Hot food item that has been cooked and refrigerated is being held for service without first being reheated to 1 65º F or above within 2 hours.",
    ...
    "05G": "Properly enclosed service/maintenance area not provided.",
...
noncritical_violations = {
    ...
    "15D": "Durable sign with license number, expiration date, and address and phone number not posted.",
    "15E": "Out-of package sale of tobacco products observed.",
    "15F": "Employee under the age of 18 selling tobacco products without direct supervision of an adult retail dealer or dealer.",
    ...
    "15O": "Sale of herbal cigarettes to minors observed.",
...
violations = {}
violations.update(critical_violations)
violations.update(noncritical_violations)
